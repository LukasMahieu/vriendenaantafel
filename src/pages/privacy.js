...
export default function Privacy ({ }) {
    return (
        <main class="font-vat_smalltext text-vat-smalltext bg-vat-background">
            <div class = "container mx-auto px-10 pt-10">
                ...
                <p class="pt-10">
                    <h1 class="font-vat">WAAROM VRIENDEN AAN TAFEL GEGEVENS NODIG HEEFT</h1>
                ...
                <p class="pt-10">
                    <h1 class="font-vat">HOE LANG VRIENDEN AAN TAFEL GEGEVENS BEWAART</h1>
                ...
                <p class="pt-10">
                    <h1 class="font-vat">DELEN MET ANDEREN</h1>
                ...
                <p class="pt-10">
                    <h1 class="font-vat">IN KAART BRENGEN WEBSITEBEZOEK</h1>
                ...
                <p class="pt-10">
                    <h1 class="font-vat">GEGEVENS INZIEN, AANPASSEN OF VERWIJDEREN</h1>

                    U heeft het recht om uw persoonsgegevens in te zien, te corrigeren of te verwijderen. U kunt een verzoek tot inzage, correctie of verwijdering sturen naar vriendenaantafel@outlook.be. Vrienden aan Tafel zal zo snel mogelijk op uw verzoek reageren.      

                    <br/>
                </p>
                <p class="pt-10">
                    <h1 class="font-vat">BEVEILIGEN</h1>
                    ...
                    Als u de indruk heeft dat uw gegevens niet goed beveiligd zijn of er aanwijzingen zijn van misbruik, of indien u meer informatie wenst over de beveiliging van door Vrienden aan Tafel verzamelde persoonsgegevens, neem dan contact met Vrienden aan Tafel op via vriendenaantafel@outlook.be. www.vriendenaantafel.be is een website van Vrienden aan Tafel. Vrienden aan Tafel is als volgt te bereiken:

                    <br/>
                    <br/>
                    Vestigingsadres: Schuttersvest 86 Mechelen
                    <br/>
                    <br/>
                    Ondernemingsnummer: 0793.216.708
                    <br/>
                    <br/>
                    Telefoon: 0477045366
                    <br/>
                    <br/>
                    E-mailadres: vriendenaantafel@outlook.be
                    <br/>
                    <br/>
                </p>
            </div>
